...
<v-card style="border-radius:0px">
        ...
        <div>
            <v-row>
                <v-col cols="12" lg="7" sm="12" class="justify-center align-center d-flex font-bold">
                    <div>
                        <h1>Hey there!</h1>
                        <h1>I'm Jimwell C. Punzalan,</h1>
                        <h1>Devoted <b class="blue--text">IT Specialist</b></h1>
                        <br>
                         <v-btn dark v-for="icon in icons" :key="icon.icon" class="mx-4" icon :href="icon.link" target="_blank">
        ...
        <div >
                ...
                <v-row>
                    <v-col cols="12" class="text-center ">
                        ...
                        <span class="text-h4 font-weight-bold font-underline">Education</span>
                        <br>
                        <v-col cols="0" lg="12">
                        </v-col>    
    ...
    <v-parallax src="images/parallax4.jpg" height="1000">

        <div>
             <v-col cols="12" class="text-center ">
                         <v-icon x-large class="blue--text mx-2 pb-5">mdi-briefcase-variant</v-icon>
                        <span class="text-h4 font-weight-bold font-underline">Experience</span>
                        <br>
                        <v-col cols="0" lg="12">
                        </v-col>    
                ...
                <v-row>
                    ...
                    <v-col cols="12">
                        ...
                        <v-img src="images/parallax2.jpg" height="400" :class="this.$vuetify.breakpoint.name == 'lg' || this.$vuetify.breakpoint.name =='xl' ? 'mt-10 customradius' : 'customradius'">
        ...
        <div id="portfolios">
                ...
                <v-row>
                    <v-col cols="12" class="text-center ">
                        ...
                        <span class="text-h3 font-weight-bold font-underline">Portfolio</span>
                        <br>
                        <v-col cols="0" lg="12">
                        </v-col>    
                                ...
                                <v-list-group v-for="item in technicalskills" :key="item.title" no-action :prepend-icon="item.icon">
                                    <template v-slot:activator>
                                        ...
                                        <v-row class="d-flex justify-center">
                                            <v-col cols="6" xl="1" lg="2" md="3" sm="4" v-for="(subitem,i) in item.items" :key="i" class="text-center">
        ...
        <v-card>
            <v-row class="mt-2 text-center grey--text">
                ...
                <v-col cols="12" md="4" sm="12" class="text-left">
                    ...
                    <v-row>
                        <v-col cols="6" lg="4" md="6" sm="4" v-for="(item,i) in reference" :key="i">
