...
<div class="titlecolor">
    ...
    <!-- <v-parallax src="images/parallax3.jpg" height="1200">
        <SkillsVue :isMobile="isMobile" :SoundEffect="SoundEffect"/>
    </v-parallax> -->
    ...
    <v-footer class="footcolor" dark>
        <div class="mb-2">
            <v-row class="mt-2 text-center grey--text">
                ...
                <v-col cols="12" md="4" :sm="screensize.width >= 739 && screensize.width <= 1280 ? 6:12" class="text-left">
                    <h2 v-intersect.quiet="onIntersect" id="references" class="white--text">REFERENCES</h2>
                    <v-row>
                        <v-col :cols="screensize.width <= 375 ? 12:6" xl="4" lg="6" md="12" :sm="screensize.width >= 667? 6: 12" v-for="(item,i) in reference" :key="i">
                ...
                <v-col cols="12" md="4" :sm="screensize.width >= 740 && screensize.width <= 1280 ? 6:12" class="text-left">
