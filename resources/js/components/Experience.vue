...
<div>
        ...
        <v-row>
            ...
            <v-col :cols="screensize.width > 911 ? 5:12" style="margin:auto" class="text-center justify-center align-center d-flex gap-0">
            ...
            <v-col :cols="screensize.width > 911 ? 7:12">
                <v-scroll-x-reverse-transition v-if="!overlaydialog || screensize.width < 912">
                        ...
                        <v-overlay :v-model="true" absolute color="#14143C" class="px-2">
                            <v-fade-transition mode="out-in">
                                <div :key="overlaytext.role">
                                    ...
                                    <span class="text-h5">Position: {{overlaytext.role}}</span>
                                    <br><br>
                                    <ul>
                                        <li v-for="(info,i) in overlaytext.info" :key="i">{{info}}</li>
                                    </ul>
...
export default {
    ...
    data: () => ({
        ...
        Experience: [{
                ...
                info: ["Diagnose and troubleshoots company's website/systems.",
                    ...
                    `Contributed a Kaizen named "Access Manager" to systemize user's access permission to "Barchart Maker" and "Shukka System".`,
                    'Developed a website system named "Balcony Handrail Management System" for Paperless and Real-Time Process Monitoring.',
                    'Developed a website system named "Nail Pitch System" to track the HTI i-Cube production data.'
                ]
            },
            {
                ...
                info: ['Applied the basic front end languages for website development (HTML, CSS, Javascript and PHP).',
                    'Developed the ElStudio I.D. System that creates and scan QR codes for Biometric purposes.'
                ]
            },
    ...
    methods: {
        ...
        mHoverSelect(item, count) {
            if (this.isMobile && this.screensize.width < 911)
                this.exptip = true
