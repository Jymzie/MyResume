...
<v-row>
    ...
    <v-col cols="12" lg="6" :sm="isMobile && screensize.width >= 739 ? 6 : 12">
        ...
        <v-carousel height="180" class="mb-n10" hide-delimiters v-if="$vuetify.breakpoint.name == 'lg' || $vuetify.breakpoint.name =='xl' || (isMobile && screensize.width >= 739) ? false : true">
...
export default {
    ...
    mounted() {
        this.$watch('screensize', (newValue, oldValue) => {
            this.overlaytext = this.Education[0]
            this.overlaycount = 0
        }, {
            deep: true
